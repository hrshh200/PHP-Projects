...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $present = "SELECT * FROM  bookusers WHERE username= '$username' AND password = '$password'";
...
<head>
    ...
    <title>BooksMania-UserLogin</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="mb-5">
                        ...
                        <h4 class="text-center mb-4" style="color: brown; font-weight:bold; font-size:50px">User Login</h4>
                    </div>
